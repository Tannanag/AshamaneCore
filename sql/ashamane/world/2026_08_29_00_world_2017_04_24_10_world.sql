...
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`StandState`,`AnimTier`,`emote`,`auras`) VALUES (@NPC,@PATH,5228,0,1,0, '17622');
...
UPDATE `creature` SET `wander_distance`=0,`MovementType`=2 WHERE `guid`=@NPC;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`StandState`,`AnimTier`,`emote`,`auras`) VALUES (@NPC,@PATH,0,0,1,0, '17622 10848');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
...
INSERT INTO `creature_template_addon` (`entry`, `path_id`, `mount`, `StandState`, `AnimTier`, `emote`, `auras`) VALUES 
...
UPDATE `creature_addon` SET `StandState`=0, `auras` = '17622 10848' WHERE `guid` = 200140;
