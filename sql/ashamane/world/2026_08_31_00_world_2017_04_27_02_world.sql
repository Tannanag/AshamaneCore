...
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `StandState`, `AnimTier`, `emote`, `auras`) VALUES
(@CGUID+0, 0, 0, 0, 1, 0, ''), 
...
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`StandState`,`AnimTier`,`emote`,`auras`) VALUES (@NPC,@PATH,0,0,1,0, '');
