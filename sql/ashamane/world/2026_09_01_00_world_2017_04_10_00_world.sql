...
(@CGUID+0, 0, 0, 0, 0, 0, ''), -- 19850
(@CGUID+1, 0, 0, 0, 0, 0, ''), -- 12788
(@CGUID+2, 0, 0, 0, 0, 0, ''), -- 12789
(@CGUID+3, 0, 0, 0, 0, 0, ''), -- 12790
(@CGUID+4, 0, 0, 0, 0, 0, ''), -- 12791
(@CGUID+5, 0, 0, 0, 0, 0, ''), -- 12793
(@CGUID+6, 0, 0, 0, 0, 0, ''), -- 12794
(@CGUID+7, 0, 0, 0, 0, 0, ''), -- 12795
(@CGUID+8, 0, 14334, 0, 0, 0, ''), -- 12796
(@CGUID+9, 0, 0, 0, 0, 0, ''), -- 12797
(@CGUID+10, 0, 0, 0, 0, 0, ''), -- 12798
(@CGUID+11, 0, 0, 0, 1, 0, ''), -- 12784
(@CGUID+12, 0, 0, 0, 0, 0, ''), -- 12785
(@CGUID+13, 0, 0, 0, 0, 0, '5301'), -- 12786 - 5301 - 5301
(@CGUID+14, 0, 0, 0, 0, 0, '5301'), -- 12787 - 5301 - 5301
(@CGUID+15, 0, 0, 0, 0, 0, '5301'), -- 12778 - 5301 - 5301
(@CGUID+16, 0, 0, 0, 0, 0, ''), -- 12779
(@CGUID+17, 0, 0, 0, 0, 0, '134735'), -- 12780 - 134735 - 134735
(@CGUID+18, 0, 0, 0, 1, 0, ''), -- 12781
(@CGUID+19, 0, 14337, 0, 0, 0, ''), -- 12783
(@CGUID+20, 0, 0, 0, 0, 0, '5301'); -- 19848 - 5301 - 5301
