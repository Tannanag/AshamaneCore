...
-- Entry 43089 does not roam. All six spawns were on random movement with a 3 yd
...
UPDATE `creature` SET `MovementType`=0, `wander_distance`=0 WHERE `id`=43089 AND `guid` IN (
    168373, 168374, 168418, 168835, 168862, 168863);

-- @touched: creature 168373,168374,168418,168835,168862,168863
